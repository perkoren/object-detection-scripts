...
Usage:
  ...
  # Create train data:
  python generate_tfrecord.py --labels_path=labels.txt --csv_input=data/train_labels.csv  --output_path=train.record

  # Create test data:
  python generate_tfrecord.py --labels-path=labels.txt --csv_input=data/test_labels.csv  --output_path=test.record
"""
